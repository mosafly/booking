...
export const PricingManagement: React.FC = () => {
  ...
  const updateCourtProductId = (courtId: string, productId: string) => {
    setCourts((prev) =>
      prev.map((court) =>
        court.id === courtId ? { ...court, lomi_product_id: productId } : court,
      ),
    )
  }
  ...
  const updateGymBookingProductId = (
    bookingId: string,
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateCourtProductId(court.id, e.target.value)
                        }
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        {(product.price_cents / 100).toFixed(0)} XOF
                      </p>
                    </div>
                    <div className="flex-1">
                      <Label
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateProductProductId(product.id, e.target.value)
                        }
                ...
                {gymBookings.map((booking) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        Type: {booking.class_type} | Price:{' '}
                        {(booking.price_cents / 100).toFixed(0)} XOF
                      </p>
                    </div>
                    <div className="flex-1">
                      <Label
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateGymBookingProductId(booking.id, e.target.value)
                        }
