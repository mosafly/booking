...
export const AdminDashboard: React.FC = () => {
  ...
  const loadStats = async () => {
    try {
      ...
      const totalRevenue = revenueRes.data?.reduce((sum, res) => sum + (res.total_price || 0), 0) || 0;
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Gérez votre complexe sportif en un seul endroit</p>
        </div>
