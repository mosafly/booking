...
export default function ProductManagementModal({ isOpen, onClose, onProductUpdated }: ProductManagementModalProps) {
                ...
                <CardContent className="p-4">
                  {editingProduct?.id === product.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Button size="sm" onClick={() => handleUpdateProduct(editingProduct)}>
                          Sauvegarder
                        </Button>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600">
                          {formatFCFA(product.price_cents)} • Stock: {product.stock_quantity}
                        </div>
                      </div>
