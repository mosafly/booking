...
-- -- Add foreign key constraint for payments.sale_id now that sales table exists
...
-- -- Remove foreign key constraint from payments table before dropping sales table
